...
use App\Models\VocabularyListeningVideo;
use Illuminate\Http\Request;

class VocabularyListeningVideoController extends BaseController
{
    protected $pageTitle = 'Danh sách video nghe';
    public function __construct()
    {
        $this->model = VocabularyListeningVideo::class;
        $this->viewPath = 'admin.crud';
        $this->route = 'admin.vocabulary-listening-videos';
