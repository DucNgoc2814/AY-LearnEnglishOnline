...
(function(d) {
  ...
  d.extend(n.prototype, {
    ...
    _buildButton: function(a, b) {
      ...
      e.tag
        ? (
            (g = d("<" + e.tag + "/>").html(h(a.text)).addClass(e.className)),
      ...
      e =
        (e = this.c.dom.buttonContainer) && e.tag
          ? d("<" + e.tag + "/>").addClass(e.className).append(l)
          : l;
      this._addKey(a);
    ...
    _popover: function(a, b, c) {
      ...
      if ("absolute" === e) {
        ...
        (e = c.height() / 2), e > d(u).height() / 2 &&
          (e = d(u).height() / 2), c.css("marginTop", -1 * e);
  ...
  m.Api.register("buttons.info()", function(a, b, c) {
    var e = this;
    if (!1 === a)
      return this.off("destroy.btn-info"), d(
