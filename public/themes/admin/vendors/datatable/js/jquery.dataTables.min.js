...
(function(h) {
  ...
  function lb(a) {
    ...
    for (c = l.length; b < c; b++)
      (f = l[b]), (d = h(f.nTh).addClass(f.sClass)), i && d.appendTo(e), a
        ...
        ), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Na(a, "header")(
        a,
        d,
        f,
        m
  ...
  function vb(a) {
    ...
    for (g = 0; g < c; g++)
      (m = b[g]), (l = f[g]), (i =
        "function" == typeof m.mData ? "function" : m.mData), G.columns.push({
        data: i,
        name: m.sName,
  ...
  function Fa(a) {
    ...
    if (d || (!t && !f && !e && j == V(a) && j == m.length))
      ...
      for (n = e = 0; n < i.length; n++)
        (k = h(m[n])), (g = k.outerWidth() - k.width()), (k = p.bBounding
  ...
  function Hb(a, b) {
    for (var c, d = -1, e = -1, f = 0, g = a.aoData.length; f < g; f++)
      (c = B(a, f, b, "display") + ""), (c = c.replace(Yb, "")), (c = c.replace(
        /&nbsp;/g,
        " "
            ...
            if (b.columns) {
              ...
              for (e = b.columns.length; d < e; d++)
                (g = b.columns[d]), g.visible !== k &&
                  (f[d].bVisible = g.visible), g.search !== k &&
          ...
          for (m = o.length; h < m; h++)
            (f = o[h]), (f =
              "cell" === b
                ...
                : c.call(r, l[g], f, g, h, n)), f !== k && e.push(f);
        }
      }
      return e.length || d
        ? (
