...
!(function(t, e) {
  ...
  class Bt extends W {
    ...
    hide() {
      ...
      (this._element.style[t] = `${this._element.getBoundingClientRect()[
        t
      ]}px`), d(this._element), this._element.classList.add(Mt), this._element.classList.remove(Pt, Nt);
  ...
  class Vs extends W {
    ...
    _toggleDropDown(t, e) {
      ...
      n(
        ".dropdown-toggle",
        Fs
      ), n(".dropdown-menu", Ws), i.setAttribute("aria-expanded", e);
    }
  ...
  N.on(document, Ls, zs, function(t) {
    ["A", "AREA"].includes(this.tagName) &&
      t.preventDefault(), l(this) || Vs.getOrCreateInstance(this).show();
  }), N.on(window, Ds, () => {
  ...
  class ro extends W {
    ...
    show() {
      N.trigger(this._element, Zs).defaultPrevented ||
        (
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove(no), N.trigger(
                this._element,
                to
      ...
      this.isShown() &&
        (N.trigger(this._element, Gs).defaultPrevented ||
          (
            ...
            this._queueCallback(
              () => {
                this._element.classList.add(eo), this._element.classList.remove(
                  no,
                  io
    ...
    _setListeners() {
      ...
      ), N.on(this._element, Xs, t => this._onInteraction(t, !1)), N.on(this._element, Ys, t => this._onInteraction(t, !0)), N.on(this._element, Us, t => this._onInteraction(t, !1));
    }
    _clearTimeout() {
  ...
  return R(
    ro
  ), m(ro), { Alert: Q, Button: Y, Carousel: xt, Collapse: Bt, Dropdown: qi, Modal: On, Offcanvas: qn, Popover: us, ScrollSpy: Es, Tab: Vs, Toast: ro, Tooltip: cs };
});
