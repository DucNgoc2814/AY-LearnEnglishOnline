            ...
            <div class="tab-content" id="shadowingTabContent">
                ...
                <div class="tab-pane fade show active" id="instructions" role="tabpanel">
                    ...
                    <div class="text-center mt-4">
                        <button class="btn btn-primary btn-lg" onclick="document.getElementById('practice-tab').click()">
                                    ...
                                    <div class="transcript-section mb-4">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-primary play-section me-2" data-time="{{ $section['time'] }}">
                                                    <i class="fas fa-play"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-success record-btn" data-section="{{ $section['time'] }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function setupRecording() {
        try {
            ...
            mediaRecorder.addEventListener('stop', () => {
                ...
                addRecordingToList(audioUrl, currentRecordingBtn.dataset.section);
                audioChunks = [];
            });
        } catch (error) {
    ...
    function addRecordingToList(audioUrl, sectionTime) {
        ...
        recordingItem.innerHTML = `
            <div class="flex-grow-1">
                <div class="d-flex align-items-center mb-2">
                    ...
                    <span>Đoạn ${sectionTime} - ${timestamp}</span>
                </div>
    ...
    function startRecording(button) {
        if (currentRecordingBtn && currentRecordingBtn !== button) {
            // Stop any other ongoing recording
            stopRecording(currentRecordingBtn);
        }

        if (mediaRecorder.state === 'inactive') {
            mediaRecorder.start();
            button.innerHTML = '<i class="fas fa-stop me-1"></i>Dừng';
            button.classList.replace('btn-outline-success', 'btn-danger');
            currentRecordingBtn = button;
        } else {
    ...
    function stopRecording(button) {
        if (mediaRecorder && mediaRecorder.state === 'recording') {
            mediaRecorder.stop();
            button.innerHTML = '<i class="fas fa-microphone me-1"></i>Ghi âm';
            button.classList.replace('btn-danger', 'btn-outline-success');
    ...
    document.querySelectorAll('.play-section').forEach(button => {
        button.addEventListener('click', function() {
            ...
            console.log('Play section at time:', time);
        });
    });
});
</script>
