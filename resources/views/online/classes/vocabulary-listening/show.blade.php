                                        ...
                                        @foreach($step['sentences'] as $index => $sentence)
                                            <div class="sentence-container mb-4" data-answer="{{ $sentence['answer'] }}">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <button class="btn btn-sm btn-outline-primary check-sentence" onclick="checkSentence(this)">
                                ...
                                @case(8)
                                    ...
                                    <div class="test-section">
                                        <div class="timer mb-4">
                                            <h6>Thời gian còn lại: <span id="countdown">10:00</span></h6>
                                        </div>
                                        <div class="test-content">
                                            <!-- Test content will be here -->
                                        </div>
                                    </div>
                                    @break
                            @endswitch
