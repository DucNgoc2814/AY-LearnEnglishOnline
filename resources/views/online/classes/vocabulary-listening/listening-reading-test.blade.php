            ...
            <div class="question-content p-4">
                <div class="image-display-section mb-4">
                    <div class="current-image-container text-center">
                        <img id="currentImage" src="" alt="Current Image" class="img-fluid rounded shadow-sm" style="max-height: 400px;">
                    </div>
                </div>
        ...
        <div class="question-card bg-white p-0 rounded-lg shadow-sm mb-4 overflow-hidden" data-question-id="10">
            ...
            <div class="question-content p-4">
                <div class="word-search-game">
                    ...
                    <div class="instructions mb-4 p-3 bg-light rounded">
                        <h6 class="mb-2"><i class="fas fa-info-circle me-2"></i>Hướng dẫn:</h6>
                        <p class="mb-0">Tìm và khoanh tròn các từ được liệt kê. Các từ có thể nằm ngang, dọc hoặc chéo.</p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const imageWordGame = {
        images: [
            { url: '/images/vocabulary/tree.jpg', word: 'tree' },
            { url: '/images/vocabulary/cat.jpg', word: 'cat' },
            { url: '/images/vocabulary/elephant.jpg', word: 'elephant' },
            { url: '/images/vocabulary/boat.jpg', word: 'boat' },
            { url: '/images/vocabulary/kite.jpg', word: 'kite' },
            { url: '/images/vocabulary/hat.jpg', word: 'hat' },
            { url: '/images/vocabulary/flower.jpg', word: 'flower' },
            { url: '/images/vocabulary/dog.jpg', word: 'dog' },
            { url: '/images/vocabulary/ice-cream.jpg', word: 'ice-cream' },
            { url: '/images/vocabulary/apple.jpg', word: 'apple' }
        ],
        currentImageIndex: 0,
        ...
        setupGame() {
            ...
            this.images.forEach(item => {
                ...
                wordButton.addEventListener('click', () => this.checkAnswer(item.word, wordButton));
    ...
    dropZones.forEach(zone => {
        ...
        zone.addEventListener('drop', function(e) {
            ...
            if (draggedActivity === correctActivity) {
                ...
                const draggedImage = document.querySelector(`[data-activity="${draggedActivity}"]`);
    ...
    class MemoryGame {
        constructor() {
            this.cards = [
                { id: 1, type: 'image', content: '/images/vocabulary/have-lunch.jpg', pair: 'have lunch' },
                { id: 2, type: 'word', content: 'have lunch', pair: 'have-lunch.jpg' },
                { id: 3, type: 'image', content: '/images/vocabulary/read-book.jpg', pair: 'read a book' },
                { id: 4, type: 'word', content: 'read a book', pair: 'read-book.jpg' },
                { id: 5, type: 'image', content: '/images/vocabulary/play-games.jpg', pair: 'play video games' },
                { id: 6, type: 'word', content: 'play video games', pair: 'play-games.jpg' },
                { id: 7, type: 'image', content: '/images/vocabulary/shower.jpg', pair: 'have a shower' },
                { id: 8, type: 'word', content: 'have a shower', pair: 'shower.jpg' },
                { id: 9, type: 'image', content: '/images/vocabulary/listen-music.jpg', pair: 'listen to music' },
                { id: 10, type: 'word', content: 'listen to music', pair: 'listen-music.jpg' },
                { id: 11, type: 'image', content: '/images/vocabulary/go-to-bed.jpg', pair: 'go to bed' },
                { id: 12, type: 'word', content: 'go to bed', pair: 'go-to-bed.jpg' },
                { id: 13, type: 'image', content: '/images/vocabulary/get-up.jpg', pair: 'get up' },
                { id: 14, type: 'word', content: 'get up', pair: 'get-up.jpg' },
                { id: 15, type: 'image', content: '/images/vocabulary/watch-tv.jpg', pair: 'watch TV' },
                { id: 16, type: 'word', content: 'watch TV', pair: 'watch-tv.jpg' },
                { id: 17, type: 'image', content: '/images/vocabulary/get-dressed.jpg', pair: 'get dressed' },
                { id: 18, type: 'word', content: 'get dressed', pair: 'get-dressed.jpg' },
                { id: 19, type: 'image', content: '/images/vocabulary/have-dinner.jpg', pair: 'have dinner' },
                { id: 20, type: 'word', content: 'have dinner', pair: 'have-dinner.jpg' }
            ];
        ...
        flipCard(element, card) {
            ...
            this.flippedCards.push({ element, card });
        ...
        checkMatch() {
            ...
            const isMatch = first.card.pair === second.card.content || second.card.pair === first.card.content;
        ...
        constructor() {
            ...
            this.questions = [
                ...
                },
                {
                    ...
                    options: ["half to eight", "half past eight", "eight and half", "eight thirty past"]
                },
                {
    ...
    class CategoryGame {
        constructor() {
            this.score = 0;
            this.items = [
                { id: 'backpack', src: '/images/items/backpack.png', category: 'school-supplies' },
                { id: 'icecream', src: '/images/items/icecream.png', category: 'food' },
                { id: 'glue', src: '/images/items/glue.png', category: 'school-supplies' },
                { id: 'fish', src: '/images/items/fish.png', category: 'food' },
                { id: 'train', src: '/images/items/train.png', category: 'toys' },
                { id: 'pencil', src: '/images/items/pencil.png', category: 'school-supplies' },
                { id: 'rice', src: '/images/items/rice.png', category: 'food' },
                { id: 'face', src: '/images/items/face.png', category: 'body-parts' },
                { id: 'soccer', src: '/images/items/soccer.png', category: 'toys' },
                { id: 'ruler', src: '/images/items/ruler.png', category: 'school-supplies' },
                { id: 'pizza', src: '/images/items/pizza.png', category: 'food' },
                { id: 'mouth', src: '/images/items/mouth.png', category: 'body-parts' },
                { id: 'foot', src: '/images/items/foot.png', category: 'body-parts' },
                { id: 'kite', src: '/images/items/kite.png', category: 'toys' },
                { id: 'arm', src: '/images/items/arm.png', category: 'body-parts' },
                { id: 'car', src: '/images/items/car.png', category: 'toys' }
            ];
        ...
        checkCategory(itemCategory, targetCategory) {
            ...
            return itemCategory === Object.keys(categoryMap).find(key => categoryMap[key] === targetCategory);
        }
            ...
            cells.forEach(cell => {
                ...
                cell.addEventListener('click', (e) => {
                    ...
                    if (clickedCell.classList.contains('selected')) {
                        ...
                        this.selectedCells = this.selectedCells.filter(c => c !== clickedCell);
                    } else {
