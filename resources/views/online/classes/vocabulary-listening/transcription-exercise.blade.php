...
<div class="transcription-exercise">
                            ...
                            <td class="phonetic-cell">
                                ...
                                <div class="feedback mt-2" style="display: none;">
                                    <div class="alert alert-success py-1 px-2 mb-0">
                                        <small><i class="fas fa-check-circle me-1"></i><span class="feedback-text"></span></small>
                                    </div>
                                </div>
                            </td>
                        </tr>
    ...
    <div class="text-center mt-4">
        <button class="btn btn-primary save-progress" onclick="saveProgress()">
