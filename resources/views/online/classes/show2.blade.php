...
@section('title', 'Khóa học IELTS Trung cấp')
...
@section('content')
    <div class="container py-4">
        <div class="class-header">
            <h1 class="class-title">Khóa học IELTS Trung cấp</h1>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="materials" role="tabpanel">
                @include('online.classes.partials.materials', ['course' => 2])
            </div>
            <div class="tab-pane fade" id="zoom" role="tabpanel">
                @include('online.classes.partials.zoom', ['course' => 2])
            </div>
            <div class="tab-pane fade" id="exercises" role="tabpanel">
                @include('online.classes.partials.exercises', ['course' => 2])
            </div>
            <div class="tab-pane fade" id="progress" role="tabpanel">
                @include('online.classes.partials.progress', ['course' => 2])
            </div>
        </div>
    </div>
@endsection
