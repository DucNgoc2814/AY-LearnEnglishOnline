                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info mb-4">
                                            ...
                                            <p class="mb-0">
                                                Listen to each sentence and practice pronouncing the words with the /ɑː/
                                        ...
                                        <div class="sentences-practice">
                                            <div class="sentence-list">
                                                ...
                                                <div class="sentence-item card mb-3">
                                                    <div class="card-body">
                                                        <div class="sentence-text mb-3">
                                                            How <span class="highlight-word">far</span> is the <span
                                                                class="highlight-word">car park</span>?
                                                        </div>
                                                        <div class="d-flex gap-2 mb-3">
                                                            <div class="audio-player-wrapper">
                                                                <audio class="original-audio" controls>
                                                                    <source src="/audio/sentences/sentence1.mp3"
                                                                        type="audio/mpeg">
                                                                    Your browser does not support the audio element.
                                                                </audio>
                                                            </div>
                                                ...
                                                <div class="sentence-item card mb-3">
                                                    <div class="card-body">
                                                        <div class="sentence-text mb-3">
                                                            We went to a <span class="highlight-word">large bar</span> full
                                                            of film <span class="highlight-word">stars</span>.
                                                        </div>
                                                        <div class="d-flex gap-2 mb-3">
                                                            <div class="audio-player-wrapper">
                                                                <audio class="original-audio" controls>
                                                                    <source src="/audio/sentences/sentence2.mp3"
                                                                        type="audio/mpeg">
                                                                    Your browser does not support the audio element.
                                                                </audio>
                                                            </div>
                                                ...
                                                <div class="sentence-item card mb-3">
                                                    <div class="card-body">
                                                        <div class="sentence-text mb-3">
                                                            We're <span class="highlight-word">starting</span> in half an
                                                            hour.
                                                        </div>
                                                        <div class="d-flex gap-2 mb-3">
                                                            <div class="audio-player-wrapper">
                                                                <audio class="original-audio" controls>
                                                                    <source src="/audio/sentences/sentence3.mp3"
                                                                        type="audio/mpeg">
                                                                    Your browser does not support the audio element.
                                                                </audio>
                                                            </div>
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">
                                            <i class="fas fa-gamepad me-2"></i>Practice 4: Short /ʌ/
                                        </h4>
                                        ...
                                        <div class="alert alert-info mb-4">
                                            ...
                                            <p class="mb-0">
                                                Find pairs of words that contain the short /ʌ/ sound. Click on the cards to
                                                flip them and match the pairs.
                                                Try to complete the game with as few moves as possible!
                                            </p>
                                        </div>

                                        <div class="memory-game-container-2">
                                            <div class="game-stats mb-4 d-flex justify-content-between align-items-center">
                                                <div class="moves">
                                                    <i class="fas fa-sync-alt me-2"></i>Moves: <span
                                                        id="moveCount2">0</span>
                                                </div>
                                                <div class="timer me-3">
                                                    <i class="fas fa-clock me-2"></i>Time: <span
                                                        id="memoryGameTimer2">0:00</span>
                                                </div>
                                                <div class="matches">
                                                    <i class="fas fa-check-circle me-2"></i>Matches: <span
                                                        id="matchCount2">0</span>/8
                                                </div>
                                            </div>
                                            <div class="memory-grid" id="memoryGrid2">
                                                <!-- Cards will be dynamically added here -->
                                            </div>
                                            ...
                                            <div class="recording-section mt-4">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <!-- Record Controls -->
                                                        <div class="record-controls mb-4">
                                                            <button id="recordButton2" class="btn btn-primary me-2">
                                                                <i class="fas fa-microphone"></i>
                                                                <span>Start Recording</span>
                                                            </button>
                                                            <div id="recordingTimer2" class="d-none">
                                                                Recording: <span id="timerDisplay2">00:00</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="recording-history">
                                                            ...
                                                            <div id="recordingsList2" class="list-group">
                                                                <!-- Recordings will be added here -->
                                                            </div>
                                                        </div>
                                                    </div>
