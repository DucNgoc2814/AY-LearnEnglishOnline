                        ...
                        <form action="{{ route('online.support.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @error('message')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Mô tả chi tiết vấn đề bạn đang gặp phải. Thông tin càng cụ thể,
                                    chúng tôi càng hỗ trợ bạn tốt hơn.</div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                @error('attachment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Hỗ trợ các định dạng: .jpg, .png, .pdf, .doc, .docx. Kích thước
                                    tối đa: 5MB.</div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-unstyled mb-0">
                                    <li class="mb-2">
                                        ...
                                        <a href="mailto:support@amazingyou.edu.vn"
                                            class="text-decoration-none">support@amazingyou.edu.vn</a>
                                    </li>
                                    <li class="mb-2">
                    ...
                    <div class="accordion" id="faqAccordion">
                        <div class="accordion-item border-0 mb-3">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Để điểm danh, bạn cần tham gia buổi học và nhấn vào nút "Điểm danh" trong mục điểm danh.
                                    Việc điểm danh chỉ có hiệu lực trong 15 phút đầu tiên của buổi học. Chi tiết hơn, bạn có
                                    thể tham khảo <a href="{{ route('online.guides.show', 'diem-danh') }}">hướng dẫn điểm
                                        danh</a>.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0 mb-3">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Nếu quên mật khẩu, bạn có thể nhấn vào liên kết "Quên mật khẩu" trên trang đăng nhập. Hệ
                                    thống sẽ gửi hướng dẫn đặt lại mật khẩu qua email đã đăng ký. Nếu vẫn gặp vấn đề, vui
                                    lòng liên hệ với bộ phận hỗ trợ qua email hoặc điện thoại.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0 mb-3">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Để tham gia buổi học trực tuyến, bạn có thể vào mục "Lớp học của tôi" hoặc "Lịch học",
                                    sau đó nhấn vào nút "Tham gia" của buổi học tương ứng. Cần đảm bảo kết nối internet ổn
                                    định và thiết bị có camera, microphone để tham gia hiệu quả.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    Bạn có thể xem điểm số và kết quả học tập bằng cách vào mục "Điểm" trong menu bên trái.
                                    Tại đây, bạn sẽ thấy điểm của tất cả các khóa học và có thể xem chi tiết điểm từng phần
                                    bằng cách nhấn vào khóa học cụ thể.
                                </div>
                            </div>
                        </div>
                    </div>
