                ...
                <div class="card-body">
                    <ul class="nav nav-tabs" id="recordsTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="awards-tab" data-bs-toggle="tab"
                                data-bs-target="#awards" type="button" role="tab" aria-controls="awards"
                                aria-selected="true">Khen thưởng</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="disciplines-tab" data-bs-toggle="tab"
                                data-bs-target="#disciplines" type="button" role="tab" aria-controls="disciplines"
                                aria-selected="false">Kỷ luật</button>
                        </li>
                    </ul>
                                        ...
                                        <tbody>
                                            @foreach($awards as $award)
                                                <tr>
                                                    ...
                                                    <td>{{ $award->level ?? '' }}</td>
                                                    <td>
                                                        <a href="{{ route('online.awards.show', $award->id ?? 1) }}" class="btn btn-sm btn-primary">
                                        ...
                                        <tbody>
                                            @foreach($disciplines as $discipline)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('online.awards.show', $discipline->id ?? 1) }}" class="btn btn-sm btn-primary">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
