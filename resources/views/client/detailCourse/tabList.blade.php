                                        ...
                                        <div class="row w-100">
                                            ...
                                            <div class="col-auto ms-auto pe-0">
                                                ...
                                                <span class="me-0 text-14px text-muted fw-400">
                                                    {{ $lesson->totalVideoDuration() }}</span>
                                            </div>
                                        </div>
                                    </button>
                                </h2>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-5 col-5 mt-5">
                                <div class="d-flex flex-column align-items-center">
                                    ...
                                    <p class="text-center text-black fw-500 mb-1">Phùng Đức Ngọc</p>
                                    <p class="text-center text-muted small">
                                        <i class="far fa-clock me-1"></i>12:04 27/03/2025
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-9 col-md-9 col-sm-7 col-7 mt-5">
                                <!-- <h3 class="mb-3">Great product, smooth purchase</h3> -->
                                <p class="text">Moreover, the course platform itself is user-friendly and
                                    intuitive. Navigating
                                    through the modules, tracking progress, and accessing resources is
                                    seamless, making the
                                    learning process enjoyable and stress-free.</p>
                            </div>
                            <div class="col-md-12">
