                        ...
                        <div class="course-right-section">
                            <div class="course-card">
                                ...
                                <div class="button">
                                    ...
                                    @else
                                        <a href="#" id="openBuyNowModal" class="buy-now-btn">
                                                            ...
                                                            <div class="custom-modal-payment-details">
                                                                ...
                                                                <div class="custom-modal-coupon">
                                                                    <input type="hidden" name="amount"
                                                                        value="{{ $course->sale_price }}" id="final-amount">
                                                                ...
                                                                <div class="custom-modal-total">
                                                                    ...
                                                                    <span
                                                                        class="custom-modal-total-price">{{ number_format($course->sale_price) }}đ</span>
                                                                </div>
                                                            </div>
...
@push('scripts')
    ...
    <script nonce="{{ csrf_token() }}">
        document.addEventListener('DOMContentLoaded', function() {
            // Đánh dấu đang xem chi tiết khóa học để tránh redirect không mong muốn
            sessionStorage.setItem('viewing_course_detail', 'true');

            // Xóa khi rời khỏi trang
            window.addEventListener('beforeunload', function() {
                // Kiểm tra nếu không chuyển sang trang thanh toán
                if (!window.location.href.includes('thanh-toan')) {
                    sessionStorage.removeItem('viewing_course_detail');
                }
            });

            // Kiểm tra nếu đang trong quá trình mua khóa học
            const buyNowBtn = document.getElementById('openBuyNowModal');
            if (buyNowBtn) {
            ...
            // Fix for the modal not showing
            const openBtn = document.getElementById('openBuyNowModal');
