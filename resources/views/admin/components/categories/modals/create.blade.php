<div class="fixed inset-0 z-50 overflow-y-auto hidden" id="createCategoryModal" aria-labelledby="createCategoryModalLabel" aria-hidden="true">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="flex justify-between items-center pb-3 border-b">
                    <h3 class="text-lg font-medium text-gray-900" id="createCategoryModalLabel">Thêm danh mục mới</h3>
                    <button type="button" class="text-gray-400 hover:text-gray-500" 
                        onclick="modalHandler.close('createCategoryModal')" aria-label="Close">
                ...
                <form action="{{ route('admin.categories.store') }}" method="POST" class="mt-4">
                    ...
                    <div class="flex justify-end pt-2 border-t">
                        <button type="button" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded mr-2" 
                            onclick="modalHandler.close('createCategoryModal')">
                            Hủy
                        </button>
