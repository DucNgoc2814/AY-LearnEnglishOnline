    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                ...
                <div class="mb-6 p-3 bg-blue-50 rounded-md mt-4">
                            ...
                            <div>
                                ...
                                <div class="mt-2 p-3 bg-gray-50 rounded-md">
                                    <label class="inline-flex items-center">
                                        <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-600" name="is_preview"
...
<script>
    ...
    function editLesson(id) {
        ...
        fetch(`/admin/lessons/${id}/edit`)
            ...
            .catch(error => {
                ...
                alert('Đã có lỗi xảy ra khi lấy thông tin bài học: ' + error.message);
            });
    }
    ...
    function populateLessonEditModal(item) {
        ...
        initializeTinyMCE(item.description || '');
    ...
    function initializeTinyMCE(content) {
        if (tinymce.get('edit_Description')) {
            tinymce.get('edit_Description').setContent(content);
        } else {
            setTimeout(() => {
                tinymce.init({
